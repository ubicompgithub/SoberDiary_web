<?php
	...
	$sql = "INSERT INTO BreathDetail (UserId,Date,Time,Timestamp,BlowStartTimes,BlowBreakTimes,PressureDiffMax,PressureMin,PressureAverage,VoltageInit,DisconnectionMillis,SerialDiffMax,SerialDiffAverage) VALUES ('$uid','$date','$time',$timestamp,$blowStartTimes,$blowBreakTimes,$pressureDiffMax,$pressureMin,$pressureAverage,$voltageInit,$disconnectionMillis,$serialDiffMax,$serialDiffAverage)";
